...
var JWT = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (this.createScopedRequired() && url) {
                    alt = new jwtaccess_1.JWTAccess(this.email, this.key);
                    return [2 /*return*/, alt.getRequestMetadata(url)];
                }
                else {
                    return [2 /*return*/, _super.prototype.getRequestMetadataAsync.call(this, url)];
                }
                return [2 /*return*/];
            });
        });
    ...
    JWT.prototype.refreshToken = function (refreshToken) {
        return __awaiter(this, void 0, void 0, function () {
            var newGToken, token, tokens;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        newGToken = this.createGToken();
                        return [4 /*yield*/, newGToken.getToken()];
                    case 1:
                        token = _a.sent();
                        tokens = {
                            access_token: token,
